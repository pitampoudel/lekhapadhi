...
import {AlertCircleIcon, CalendarIcon, HomeIcon, Loader2Icon, UserIcon, Users2Icon} from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {fields.map((field) => (
                    ...
                    >
                        <label
                            htmlFor={field.id}
                            className="block text-lg font-medium mb-3 text-theme-gray-800 items-center"
                        >
                            {field.label}{" "}
